    ...
    return Scaffold(
      ...
      body: LayoutBuilder(builder: (context, contraints) {
        if (contraints.maxWidth > 650) {
          return _CiudadanoDesktop();
        } else {
          return _CiudadanoMobile();
        }
      }),
    );
  }
...
class _CiudadanoMobile extends StatelessWidget {
  const _CiudadanoMobile({super.key});
...
class _CiudadanoDesktop extends StatelessWidget {
  const _CiudadanoDesktop({super.key});
